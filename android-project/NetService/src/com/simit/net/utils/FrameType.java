...
public class FrameType {
	...
	//客户端自定义内部传输
	public static final int INTERIOR_SERVER_START =400,
			INTERIOR_SERVER_START_FAIL =401,
			INTERIOR_SERVER_STOP =402,
			INTERIOR_SERVER_STOP_FAIL =403,
			INTERIOR_SERVER_LOGIN =404,
			INTERIOR_SERVER_LOGIN_FAIL =405,
			INTERIOR_SERVER_LOGOUT=406,
			INTERIOR_SERVER_LOGOUT_FAIL=407;
