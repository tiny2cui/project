...
import com.simit.video.stream.H264Stream;
import com.simit.video.stream.VideoQuality;
import com.simit.video.stream.VideoStream;
...
public class Session {
	...
	private static int defaultCamera = CameraInfo.CAMERA_FACING_FRONT;
...
//			stream = new H263Stream(camera);
		...
		if (stream != null) {
			...
			stream.setSender(send);
			tracks.add(new Track(stream,Track.VIDEO));
			Log.d(TAG,videoQuality.bitRate+"+"+videoQuality.frameRate);
		}
	}
