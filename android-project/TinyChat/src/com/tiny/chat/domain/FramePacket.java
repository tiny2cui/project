...
//	private int lenData=-1; //数据长度
	...
	public int getSourceID() {
		...
		if(frameHeader!=null){
			...
			System.arraycopy(framePacket, posSourceID, tempByte, 0, lenSourceID);
		}
	...
	public int getFrameType() {
		...
		if(frameHeader!=null){
			...
			System.arraycopy(framePacket, posFrameType, tempByte, 0, lenFrameType);
		}
		return (int) TypeConvert.byte2short(tempByte);
	}
	...
	public int getFrameSerial() {
		...
		if(frameHeader!=null){
			...
			tempByte = framePacket[posFrameSerial];
		}
